...
export default function SubmissionChangeRequestCard({
    type,
    submissionId,
    count: externalCount,
    onCountLoaded,
    ...
    const { data, loading } = useFetch<any>({
        url: `/api/intake-form/submission/pending_change_request`,
    ...
    const href = `/${locale}/intake-form/${type}/submission/${submissionId}/change-request`;
