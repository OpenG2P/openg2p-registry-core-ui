                    ...
                    <div className="w-full lg:w-[70%]">
                        <div className="border rounded-lg p-4 bg-white flex flex-col">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-4">
                                <div className="space-y-1 text-sm">
                                    <div className="font-semibold">
                                        Change ID: {details.change_request_id}
                                    </div>
                                    <div>
                                        Status:{" "}
                            ...
                            <div className="mt-auto pt-4 flex justify-end gap-3 border-t">
                                <button
                                    type="button"
                                    className="px-5 py-2 text-sm font-medium rounded-md bg-gray-600 text-white hover:bg-gray-700 transition-colors"
                                >
                                    Reject
                                </button>
                                ...
                                <button
                                    type="button"
                                    className="px-5 py-2 text-sm font-medium rounded-md bg-gray-900 text-white hover:bg-black transition-colors"
                                >
                                    Approve
                                </button>
                            </div>
