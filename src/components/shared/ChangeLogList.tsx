...
export default function ChangeLogList({ logs, type, registerId }: Props) {
        ...
        <div className="space-y-4">
            {logs.map((log) => (
                <div
                    ...
                    className="grid grid-cols-1 md:grid-cols-3 gap-4 border rounded-lg bg-white p-4 relative"
                >
                    <div className="space-y-1">
                        ...
                        <div className="text-sm">
                            Status: <span className="font-medium">{log.approval_status}</span>
                        </div>
                        <div className="text-sm">
                            Change Date:{" "}
                    ...
                    <div>
                        <button
                            onClick={() =>
                                router.push(
                                    `/register/${type}/${registerId}/change-request/${log.change_log_id}`
                                )
                            }
